...
bl_info = {
    ...
    "version": (0, 1, 0),
    "blender": (2, 7, 9),
    "description": "Generate low-poly builbings by params - with, height, level count, window size etc.",
    "category": "Add Mesh"
}
...
class BuildingMakerPanel(bpy.types.Panel):
    ...
    def draw(self, context):
        ...
        self.layout.prop(
            bpy.context.scene.building_props,
            'interval_width_prop')
...
class MakeBuilding(bpy.types.Operator):
    ...
    def action_common(self, context):
        ...
        length_x = bpy.context.scene.building_props.size_x_prop
        length_y = bpy.context.scene.building_props.size_y_prop
...
def register():
    ...
    bpy.types.Scene.building_props = bpy.props.PointerProperty(
        type=MakerPanelProperties)
